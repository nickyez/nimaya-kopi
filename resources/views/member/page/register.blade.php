                ...
                <div class="d-flex flex-grow-1 flex-column align-items-start justify-content-center ">
                    ...
                    <form method="post" action="{{Request::url().'/auth'}}" class="w-100 mt-5" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column" style="margin-top: 80px">
                            <button class="btn btn-dark mb-3 rounded-pill" type="submit">Sign Up</button>
                            <a href="{{ url('/member/login') }}" class="btn btn-outline-dark rounded-pill">Sign In</a>
                        </div>
                    </form>
                </div>
            </div>
        </div>
        <div id="login-img" class="col-md-6 col-12 py-5" style="background-image: url('{{ asset('img/img_kopi.png') }}')">
            <div class="d-flex justify-content-center align-items-end h-100">
                <span class="text-white text-center font-weight-bold" style="font-size: 32px;">Secangkir Kopi,<br>Dengan
                    Berbagai Arti</span>
            </div>
        </div>
    </div>
