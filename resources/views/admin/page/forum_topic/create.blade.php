    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Tambah Topik dalam Forum</h6>
        ...
        <form action="{{ url('/admin/forum-topic') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <div class="small mb-1">Nama Topik</div>
                    <input type="text" class="form-control" name="nama_topik" id="nama_topik" required>
                </div>
