        ...
        <form action="{{ url('/admin/article') . '/' . $article->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="slug" id="slug" value="{{ $article->slug }}"
                        required>
                </div>
                <div class="form-group">
                    <div class="small mb-1">deskripsi</div>
                    <textarea id="deskripsi" class="form-control" name="deskripsi" rows="10" cols="50">value="{!! $article->deskripsi !!}"</textarea>
                </div>
